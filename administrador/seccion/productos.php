...
switch($accion){
    ...
    case "Agregar":
        $sentenciaSQL= $conexion->prepare("INSERT INTO productos (nombre, empresap, imagen) VALUES (:nombre, :empresap, :imagen);");
        $sentenciaSQL->bindParam(':nombre',$txtNombre);
        $sentenciaSQL->bindParam(':empresap',$txtEmpresa);
...
<input type="text" required class="form-control" value="<?php echo $txtEmpresa; ?>" name="txtEmpresa" <?php echo ($accion=="Seleccionar")?"disabled":""; ?> id="txtEmpresa" placeholder="Nombre de la empresa del producto">
</div>
...
<table class="table table-bordered">
    ...
    <?php foreach ($listaProductos as $producto) { ?>
        <tr>
            ...
            <td><?php echo $producto['empresap']; ?></td> 
            <td>
